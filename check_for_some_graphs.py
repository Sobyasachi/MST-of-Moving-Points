...
no_of_points = 6
all_points = [Point(2,19), Point(12,2), Point(1,16), Point(8,17),Point(8,15),Point(12,19)]
random_point_name = [(5,3),(4,1),(0,2)]
...
# old_spanning_tree.add_edge(all_points[0],all_points[3])
# old_spanning_tree.add_edge(all_points[2],all_points[0])
# old_spanning_tree.add_edge(all_points[0],all_points[5])
# old_spanning_tree.add_edge(all_points[0],all_points[6])
# old_spanning_tree.add_edge(all_points[5],all_points[1])
# old_spanning_tree.add_edge(all_points[7],all_points[1])
# old_spanning_tree.add_edge(all_points[4],all_points[7])
